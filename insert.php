 ...
 header("Location:index.php?submit=1"); 
  ...
  {header("Location:grievance.php?gsubmit=1"); 
		...
		if(isset($_POST['submitreply']))
	{
		...
		if ($_POST["pos"]==1)
		{
			$sql ="update grievance set  replystatus='close', fwdreply='".$_POST["reply"]."' , fwdreplier='".$_POST["name"]."', fwdreply_timestamp=now() where id='".$_POST["studid"]."' and gid='".$_POST["gid"]."'";   
		}
		else
...
echo $sql;		  
  ...
  {header("Location:admin/addmember.php?addmember=1");
