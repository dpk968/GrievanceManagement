...
$query=mysqli_query($conn,"update grievant set phone_no='$contactno',year='$year' where id='".$_SESSION['studid']."'");
if($query)
{
...
$ret1=mysqli_query($conn,"select * FROM grievant where id='".$studid."'");
...
?>
                                ...
                                <tr height="50">
                                    <td><b>Session:</b></td>
                                    <td><input type="text" value="<?php echo htmlentities($row['session']); ?>" name="session" style="border:none;cursor:not-allowed;" readonly></td>
                                </tr>
                                <tr height="50">
                                ...
                                <tr height="50">
                                    <td><b>Year:</b></td>
                                    <td><input type="text" value="<?php echo htmlentities($row['year']); ?>" name="year" style="border:none;background-color:#BBCAD9;"></td>
                                </tr>


                                <tr height="50">
                                    <td><b>Roll No:</b></td>
                                    <td><input type="text" value="<?php echo htmlentities($row['admissionnum']); ?>" style="border:none;cursor:not-allowed;" readonly></td>
                                </tr>
