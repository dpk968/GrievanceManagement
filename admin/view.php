...
?>
                                        ...
                                        <tr>
                                            <td><b>Forward Status </b></td>

                                            <td colspan="5"> <?php echo htmlentities($row['fwdstatus']);?></td>

                                        </tr>
                                        <tr>
                                            <td><b>Forward Reply</b></td>

                                            <td colspan="5"> <?php echo htmlentities($row['fwdreply']);?></td>

                                        </tr>
                                        <tr>
                                            <td><b>Forward Replier </b></td>

                                            <td colspan="5"> <?php echo htmlentities($row['fwdreplier']);?></td>
