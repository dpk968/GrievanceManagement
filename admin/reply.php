 ...
 <link href="style.css" rel="stylesheet">
    ...
    <section id="main-content" style="margin-left:15%;">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><!--<i class="fa fa fa-bars">-->Grievances</h3>
            <ol class="breadcrumb">
...
<input type="submit" name="submitreply" value="submit" class="btnRegister" style="width:15%;color:#fff;background-color:#3833B0;margin-right:35%;float:right;border-radius:45%;line-height:3em;"> 
