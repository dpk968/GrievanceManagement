                    ...
                    <div class="tab-pane fade active in" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="row register-form">
                            ...
                            <form action="checklogin.php" name="student_form" onsubmit="return(studentValidate());" method="post">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="password" name="password" class="form-control" placeholder="Your password*" value="" required style="border-radius: 20px;">
                            ...
                            <input type="button" class="btnRegister" name="register" value="Register" onclick="window.location.href = '/project/index1.php';">
                        </div>
                    </div>
                        ...
                        <div class="row register-form">
                            ...
                            <form action="checklogin.php" method="post" name="staff_form" onsubmit="return(staffValidate());">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control" placeholder="Your password *" value="" name="staffpwd" required style="border-radius: 20px;">
                                    </div>
                                    <div class="form-group">
